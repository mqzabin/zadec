...
[![Go Report Card](https://goreportcard.com/badge/github.com/mqzabin/zadec)](https://goreportcard.com/report/github.com/mqzabin/zadec)

Fixed-precision zero allocation decimal numbers in Go.
...
import (
	...
	"github.com/mqzabin/zadec"
)

func main() {
	a, _ := zadec.NewFromString("99999999999999999999999999999999999.999999999999999999")
	b, _ := zadec.NewFromString("888888888888888888.888888888888888888")
...
`zadec` uses an array of `uint64` to represent decimal numbers. Each `uint64` represents up to 18-digits.
...
`zadec` makes this hypothesis false to reduce allocations to zero, using fixed-size arrays to represent integer values.

# Benchmarks
```
goos: linux
goarch: amd64
pkg: github.com/mqzabin/zadec
cpu: 12th Gen Intel(R) Core(TM) i7-1265U
BenchmarkNewFromString/zadec-12               1812570               641.2 ns/op             0 B/op          0 allocs/op
BenchmarkNewFromString/shopspring-12          2574252               458.7 ns/op           184 B/op          5 allocs/op
BenchmarkString/zadec-12                      8340163               149.3 ns/op            64 B/op          1 allocs/op
BenchmarkString/shopspring-12                 4348003               270.1 ns/op           320 B/op          5 allocs/op
BenchmarkAdd/zadec-12                        34227067                32.50 ns/op            0 B/op          0 allocs/op
BenchmarkAdd/shopspring-12                    5471982               225.6 ns/op           296 B/op          7 allocs/op
BenchmarkSub/zadec-12                        22223533                54.08 ns/op            0 B/op          0 allocs/op
BenchmarkSub/shopspring-12                    5219170               226.3 ns/op           296 B/op          7 allocs/op
BenchmarkMul/zadec-12                         4043478               298.6 ns/op             0 B/op          0 allocs/op
